library(readxl)
stock_index1 <- read_excel("E:/paper6/code/stock_index1.xlsx")
...
dcc.garch11.spec = dccspec(uspec = multispec(replicate(9,garch11.spec)),dccOrder = c(1,1),
      distribution = "mvnorm")
dcc_fit=dccfit(dcc.garch11.spec, data = scenario)
file1="G:/paper6/code/"
for (i in c(1:20)){
  samples=dccsim(dcc_fit,n.sim=1000)
